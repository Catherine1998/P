...
public class FacturarM {
    ...
    public FacturarM(int Id_Transaccion, int Total, String tipo_documento, String huesped, Date fecha) {
    ...
    public FacturarM(int Id_Transaccion, int Id_Servicio, int Id_TipoDocumento, int Cantidad, int Total) {
        this.Id_Transaccion = Id_Transaccion;
